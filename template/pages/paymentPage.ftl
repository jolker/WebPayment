...
<html lang="en">
  ...
  <body>
    ...
    <div class="wrap-content wrap-content-event">
      <div class="container">
        <p class="text-center title-content" style="margin: 5px auto;">Chọn hình thức nạp ncoin</p>
        <div class="row justify-content-center">
          <a href="#" class="col-4 col-md-2 text-center content-choose-case-payment pay-card">
            <img src="${root_url}img/card.png" height="50px;">
          </a>
          <a href="#" class="col-4 col-md-2 text-center content-choose-case-payment pay-sms">
            <img src="${root_url}img/sms.png" height="50px;">
          </a>
        </div>
    ...
    <script src="${root_url}custom/js/paymentPage.js"></script>
  </body>
</html>
